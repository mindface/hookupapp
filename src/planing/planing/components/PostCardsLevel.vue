<template>
<div class="post-card-classter _flex_">
  <post-card-view
    v-if="cardViewSwitch"
    ...
    <div class="contents-box__header">
      <div class="content">
        <div class="content-body _flex_">
          <h3 class="content-title">処理方法の言語化 </h3>
         ...
         class="_flex_">
          ...
          <div class="post-card-blocks">
            ...
            <draggable
             ...
             data-group="2"
            >
              <div class="post-card" v-for="item in flow02"
               :key="item.id"
               :data-post="item.guropsnumber"
               :data-post-id="item.id"
               :data-post-category="item.category"
          ...
          <div class="post-card-blocks">
            ...
            <draggable
              ...
              data-group="3"
            >
              <div class="post-card" v-for="item in flow03"
                :key="item.id"
                :data-post="item.guropsnumber"
                :data-post-id="item.id"
                :data-post-category="item.category"
...
export default {
  ...
  computed: {
    ...
    flow01(){
      return this.postDate ? this.postDistribution(this.postDate ,1) : []
    },
    flow02(){
      return this.postDate ? this.postDistribution(this.postDate ,2) : []
    },
    flow03(){
      return this.postDate ? this.postDistribution(this.postDate ,3) : []
    }
  },
  async mounted() {
